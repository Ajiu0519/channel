...
if selected_metric == '全部客户':
    st.markdown("一、渠道趋势分析  \nSDK聚合：  \n
    六月期间，SDK聚合渠道在吸引客户方面表现平平，未展现出显著增长动力。然而，进入七月后，该渠道展现出积极的增长态势，特别是在7月15日至7月21日这一周期内，
    达到了近两个月来的相对高点，显示出较强的增长潜力，鉴于其后期增长势头，建议持续关注并优化SDK聚合策略，以进一步扩大其市场影响力。  \n  \nTMK短信：  \n
    TMK短信渠道的数据波动显著，初期表现强劲，各链路接量均正常。然而，自六月中下旬达到中高水平后，接量开始持续下滑，至7月15日至7月21日期间，
    仅三个链路（309-衢州耀晨、330-衢州耀晨、478-锦囊互动）保持接量，而“杭州乐喻”的id-323链路在经历六月首周高峰后，接量显著下滑，深入分析接量下滑原因，
    调整内容、发送时机或目标受众，恢复并提升接量水平。同时，考虑拓展新的有效链路，分散风险。  \n  \n私域：  \n
    私域渠道数据表现相对稳定，但呈现出缓慢下降的趋势，说明私域用户黏性有待加强。建议加强私域运营，提升用户体验，通过精准营销、内容创新等手段增强用户粘性，促进用户活跃与转化。  \n  \n
    花骡直播：  \n花骡直播渠道初期增长迅速，但随后进入平台期，各链路吸引客户数量均出现一致下降，说明该渠道可能已触及增长瓶颈。建议探索直播内容创新、互动形式优化等策略，
